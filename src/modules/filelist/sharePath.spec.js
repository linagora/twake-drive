...
describe('makeFileSharePath', () => {
  it.each`
    ...
    ${'file-root shared drive inside sharings'}        | ${{ _id: 'file-1', id: 'file-1', driveId: 'drive-1', drive_root_type: DRIVE_ROOT_TYPE.FILE }} | ${'/sharings'}                                 | ${'/sharings/shareddrive/drive-1/file/file-1/share'}
    ${'file-root shared drive with id only'}           | ${{ id: 'file-1', driveId: 'drive-1', drive_root_type: DRIVE_ROOT_TYPE.FILE }}                | ${'/sharings'}                                 | ${'/sharings/shareddrive/drive-1/file/file-1/share'}
    ${'file-root shared drive with _id only'}          | ${{ _id: 'file-1', driveId: 'drive-1', drive_root_type: DRIVE_ROOT_TYPE.FILE }}               | ${'/sharings'}                                 | ${'/sharings/shareddrive/drive-1/file/file-1/share'}
    ...
    ${'folder-root shared drive with both ids'}        | ${{ _id: 'folder-1', id: 'folder-1', driveId: 'drive-1' }}                                    | ${'/sharings'}                                 | ${'/shareddrive/drive-1/folder-1/file/folder-1/share'}
    ${'folder-root shared drive with _id only'}        | ${{ _id: 'folder-1', driveId: 'drive-1' }}                                                    | ${'/sharings'}                                 | ${'/shareddrive/drive-1/folder-1/file/folder-1/share'}
    ${'folder-root shared drive with id only'}         | ${{ id: 'folder-1', driveId: 'drive-1' }}                                                     | ${'/sharings'}                                 | ${'/shareddrive/drive-1/folder-1/file/folder-1/share'}
