import { Attachment, Check, Link } from '@linagora/twake-icons'
...
export const filePickerActions = [
  ...
  },
  {
    ...
    configKey: 'downloadLink',
    icon: Attachment,
    localeKey: 'FilePicker.footer.buttons.temporaryDownloadLink'
  },
  {
    mode: filePickerLinkModes.PUBLIC_LINK,
    configKey: 'sharingLink',
    icon: Link,
    localeKey: 'FilePicker.footer.buttons.publicLink'
  }
]
