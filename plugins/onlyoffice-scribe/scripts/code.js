(function(window, undefined) {
  ...
  // Prevents init() from interfering during paste.
  ...
  window.Asc.plugin.init = function(data) {
    ...
    // Fetch plain text via GetSelectedText (needed for intent data and fallback)
    window.Asc.plugin.executeMethod("GetSelectedText", [{
      ...
      // Push selection to React (one-way, no response expected)
