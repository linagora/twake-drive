...
- [x] **MOUSE-02**: L'utilisateur peut deplacer la fenetre de resultat en cliquant-glissant sur le fond (hors boutons et zone de texte)
- [x] **MOUSE-03**: L'utilisateur peut redimensionner la fenetre de resultat via un handle discret en bas a droite
...
| MOUSE-02 | Phase 15 | Complete |
| MOUSE-03 | Phase 15 | Complete |
