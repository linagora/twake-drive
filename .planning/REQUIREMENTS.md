...
- [ ] **API-02**: Scribe sends correct prompt to LLM based on selected action and text via POST /ai/v1/chat/completions
- [ ] **API-03**: Free-prompt action sends user's custom instruction to LLM with selected text
