# Requirements (ARCHIVED): Scribe v3.1 Contrat de réponse structurée LLM (MCP-ready)

**Status:** ✅ SHIPPED 2026-06-24 — 19/19 requirements complete
**Defined:** 2026-06-16
...
> Archived from `.planning/REQUIREMENTS.md` at v3.1 milestone close. A fresh REQUIREMENTS.md is created for the next milestone.
...
| CONTRACT-02 | v3.1-04 | Complete |
| FRAG-01 | v3.1-04 | Complete |
| FRAG-02 | v3.1-04 | Complete |
| FRAG-03 | v3.1-04 | Complete |
| FRAG-04 | v3.1-04 | Complete |
| KBD-01 | v3.1-04 | Complete |
| KBD-02 | v3.1-04 | Complete |
| KBD-03 | v3.1-04 | Complete |
| KBD-04 | v3.1-04 | Complete |
...
*Roadmap mapped: 2026-06-16 (v3.1-01 to v3.1-05); re-mapped 2026-06-22 (split into v3.1-05/06/07)*
*Archived: 2026-06-24 at v3.1 milestone close*
